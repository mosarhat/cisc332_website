...
if ($selectedSubCommittee !== '') {
    $query = "SELECT cm.fname, cm.lname 
...
<body>
    ...
    <?php if ($selectedSubCommittee !== ''): ?>
        <h3 class="subheading" style="text-align:center;">Members of <?= htmlspecialchars($subCommittees[array_search($selectedSubCommittee, array_column($subCommittees, 'subCommitteeID'))]['committeeName']) ?></h3>
